...
data_pv = readtable('dayton_2022_edited_720_2.csv');
GHI = data_pv.GHI;
...
problem.Objective = ((el_per_kw.*Pel_rated2.*1000) + (pv_per_kw.*Ppv_rated2.*1000) + (battery_per_kwh.*ES_rated2.*1000)) + sum(((0.075.*(el_per_kw.*Pel_rated2.*1000) + 0.01.*(pv_per_kw.*Ppv_rated2.*1000) + 0.025.*(battery_per_kwh.*ES_rated2.*1000))./discount_factors));
