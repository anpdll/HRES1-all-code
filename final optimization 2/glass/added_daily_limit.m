...
yearly_demand = 562189; 
hours_yearly = 6000;

h2_share = 0.2;

mh2Year_required = h2_share .* yearly_demand;
mh2hour_limit = yearly_demand./hours_yearly;

% Economic Data
pv_per_kw = 981; % cost of panel per kW
battery_per_kwh = 276; % cost of battery per kWh
el_per_kw =  705;
burner_conversion_cost = 0.3177226060 .* 1e+06;
...
options2 = optimoptions("intlinprog","MaxTime",3600,"IntegerTolerance",0.00001,"Display","final");
