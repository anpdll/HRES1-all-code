...
tic
solution_combo = cell(10,1);
for h2_share = 1:10
    mh2Year_required = (h2_share/10).*yearly_demand;
    ...
    options2 = optimoptions("intlinprog","MaxTime",3600,"IntegerTolerance",0.001 ...
        ,"Display","final");
    ...
    solution_combo{h2_share} = solution;
